...
function getSectionKeywords(industry) {
  const map = {
    // Slot order: [0] hero/establishing scene · [1] practitioner at work (people ok) ·
    // [2]-[5] subject/object/result close-ups (de-peopled for trades & property,
    // action-subject for body/service work — avoid static headshots/portraits).
    "Yoga & Fitness":       ["yoga studio interior bright airy","yoga class group practicing","woman yoga warrior pose","yoga meditation floor mat","yoga stretching sunrise silhouette","yoga mat blocks studio"],
    "Pilates & Barre":      ["pilates studio reformer interior","pilates instructor guiding class","pilates reformer exercise","barre ballet workout studio","pilates core mat exercise","pilates equipment studio bright"],
    "Gym & CrossFit":       ["modern gym interior equipment wide","crossfit class training workout","barbell weightlifting close up","dumbbell rack gym","battle ropes workout","kettlebell gym floor"],
    "Personal Training":    ["gym training floor interior","trainer coaching client weights","dumbbell workout close up","outdoor fitness training","kettlebell strength exercise","gym dumbbells equipment"],
    "Beauty & Hair Salon":  ["hair salon interior modern bright","hairstylist cutting client hair","blonde hair styling close up","hair coloring foils salon","salon styling chair mirror","hairdressing scissors comb tools"],
    "Nail Studio & Spa":    ["nail salon interior modern","manicure technician hands working","manicured nails close up","nail polish colors display","pedicure spa treatment","nail art design hands"],
    "Barbershop":           ["barbershop interior vintage leather","barber cutting hair clippers","beard trim close up","barber chair leather mirror","straight razor shave","barber scissors comb tools"],
    "Restaurant & Café":    ["restaurant interior dining ambient","chef plating dish kitchen","gourmet plated food close up","restaurant table setting","pasta dish fine dining","wine glass dinner table"],
    "Coffee Shop & Bakery": ["cozy coffee shop interior morning","barista making latte art","coffee latte art close up","fresh bakery pastries display","croissants bread basket","espresso machine cafe counter"],
    "Photography":          ["photography studio lighting setup","photographer shooting model studio","dslr camera lens close up","camera on tripod","photo studio backdrop lights","vintage camera flat lay"],
    "Videography":          ["video production studio set","videographer filming camera","cinema camera close up","film set lighting equipment","video editing timeline screen","camera gimbal rig"],
    "Real Estate Agency":   ["modern luxury house exterior","real estate agent showing home","bright open plan living room","luxury kitchen marble island","master bedroom interior design","house pool backyard exterior"],
    "Life Coaching":        ["bright calm office coaching space","life coach conversation session","notebook goals planning desk","two people meeting cafe talk","sunrise path walk motivation","journal coffee planning desk"],
    "Business Consulting":  ["modern office boardroom interior","business meeting discussion table","charts analytics laptop screen","whiteboard strategy planning","business handshake deal","office desk documents laptop"],
    "Healthcare & Wellness":["modern medical clinic interior","doctor consulting patient clinic","stethoscope medical desk close up","wellness spa treatment room","medical equipment clinic","clinic reception waiting area"],
    "Dental Practice":      ["modern dental clinic interior","dentist treating patient chair","dental tools tray close up","dental chair equipment room","bright smile teeth close up","dental clinic bright clean"],
    "Clothing Boutique":    ["clothing boutique interior racks","woman browsing boutique shopping","clothes on rack close up","fashion store window display","folded clothes retail shelf","handbags accessories display"],
    "Online Store":         ["ecommerce product flat lay minimal","packing shipping order box","product photography white background","parcels delivery shopping","minimal product display studio","gift boxes packaging detail"],
    "Education & Tutoring": ["bright modern classroom interior","tutor teaching student desk","books notebooks study desk","child writing homework","library bookshelves rows","pencils stationery learning"],
    "Tech Startup":         ["modern tech office open space","developers coding collaboration","code on laptop screen close up","multiple monitors coding desk","startup whiteboard brainstorm","laptop coffee workspace desk"],
    "Law Firm":             ["law office interior bookshelves","lawyer client meeting desk","law books gavel desk","conference room table office","signing contract documents","scales of justice desk"],
    "Accounting":           ["modern accounting office interior","accountant meeting client desk","calculator financial documents","spreadsheet charts laptop","tax paperwork desk close up","coins calculator finance"],
    "Event Planning":       ["elegant wedding reception venue","event planner setting decor","wedding table floral setting","string lights event decoration","banquet hall chairs setup","floral centerpiece candles"],
    "Catering":             ["catering buffet spread table","chef serving catering event","gourmet canapes platter close up","food buffet display elegant","catering plated dishes","dessert table catering"],
    "Interior Design":      ["luxury living room interior design","interior designer arranging space","modern bedroom interior","designer kitchen interior","decor cushions sofa detail","color swatches design materials"],
    "Cleaning Services":    ["spotless clean modern living room","cleaner wiping surface gloves","cleaning supplies spray bottles","sparkling clean kitchen counter","mop bucket floor cleaning","vacuum cleaning carpet"],
    "Landscaping":          ["beautiful landscaped garden yard","landscaper mowing lawn working","manicured green lawn close up","garden flower beds design","hedge trimming garden tools","stone path patio garden"],
    "Automotive":           ["auto repair workshop garage","mechanic repairing car engine","car engine close up detail","car on lift garage service","tire wheel garage tools","car dashboard diagnostic"],
    "Plumbing":             ["modern bathroom plumbing fixtures","plumber fixing pipe under sink","copper pipes plumbing close up","wrench plumbing tools fittings","kitchen sink faucet installation","water heater boiler unit"],
    "Electrical":           ["electrical panel wiring close up","electrician wiring outlet hands","electrical wires cables close up","circuit breaker panel box","ceiling light fixture installation","multimeter electrical tools"],
    "Roofing":              ["house new shingle roof exterior","roofers installing roof shingles","asphalt shingles roof close up","damaged roof missing shingles","metal roof house sunny","roof gutter installation detail"],
    "HVAC":                 ["hvac air conditioning units outdoor","technician servicing hvac unit","air conditioner unit close up","ductwork ventilation system","thermostat wall control close up","furnace heating system unit"],
    "Pest Control":         ["pest control van house exterior","exterminator spraying treatment home","pest control sprayer equipment","termite wood damage close up","rodent trap pest control","house exterior inspection"],
    "Construction":         ["construction site building wide","construction workers building site","building framework structure","blueprint hard hat tools","concrete construction work","crane construction building"],
    "Other":                ["modern office workspace bright","team collaboration meeting office","laptop desk workspace minimal","business handshake partnership","notebook coffee desk workspace","city business building exterior"],
  };
...
"DESIGN — follow this EXACT system. This is what separates a premium agency site from a cheap one:",
    ...
    "- Stat counters: count up from 0 to target over 2s using requestAnimationFrame when scrolled into view (font-variant-numeric:tabular-nums). Only animate real figures the user provided — never fabricate stats; if there are none, show qualitative value badges instead.",
...
───────────────────────────────────────────────────────────────────────────── */
// COMPARISONS / INDUSTRY_PAGES / MARKETING_PAGES now live in ./seo-pages.js
// (imported at the top) so the build-time prerender script can share them.
